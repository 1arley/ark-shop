...
import { ShoppingCart, Search, Menu, X, User, LogOut, Settings, Bell, Edit3, LayoutDashboard, ShoppingBag } from 'lucide-react'
...
// Stable nav links — avoids recreation on every render
const NAV_LINKS = [
  { href: '/', label: 'Home' },
          ...
          <div className='flex items-center gap-2 md:gap-6'>
            ...
            <div className='hidden md:flex items-center'>
              <div className='relative group'>
                <Search className='absolute left-3.5 top-1/2 transform -translate-y-1/2 w-4 h-4 text-slate-500 group-focus-within:text-violet-400 transition-colors' aria-hidden="true" />
                <Input
                  type='text'
                  placeholder='Search...'
            ...
            <div className='hidden md:block w-px h-6 bg-slate-700/50' aria-hidden="true" />

            {/* Cart — always visible on mobile and desktop */}
            <Link
              href='/cart'
            ...
            <div className='hidden md:flex items-center gap-3'>
              {isAuthenticated ? (
                <>
                  ...
                  {/* Separator */}
                  <div className='w-px h-5 bg-slate-700/40' aria-hidden="true" />
